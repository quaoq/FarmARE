    ...
    def _write_native_artifacts(
        ...
        *,
        ...
        row = {
            ...
            "team_call_budget_exhausted": outcome.get("team_call_budget_exhausted"),
            "team_token_budget_exhausted": outcome.get("team_token_budget_exhausted"),
            "per_agent_budget_status": outcome.get("per_agent_budget_status"),
            ...
            **{
            ...
            "combine_grain_kg": outcome.get("combine_grain_kg"),
            "trailer_grain_kg": outcome.get("trailer_grain_kg"),
            "warehouse_grain_kg": outcome.get("warehouse_grain_kg"),
            "some_grain_stored": outcome.get("some_grain_stored"),
            "harvest_complete": outcome.get("harvest_complete"),
            "all_harvested_grain_accounted_for": outcome.get(
                "all_harvested_grain_accounted_for"
            ),
            "storage_complete": outcome.get("storage_complete"),
            "postharvest_compliant": outcome.get("postharvest_compliant"),
            "measurement_time": outcome.get("measurement_time"),
            "scenario_horizon": outcome.get("scenario_horizon"),
