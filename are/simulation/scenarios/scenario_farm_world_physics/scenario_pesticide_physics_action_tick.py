...
class ScenarioFarmWorldPesticidePhysicsActionTick(Scenario):
    ...
    def _gates(self) -> list[GateSpec]:
        return [
            GateSpec(name="G1_observe_pest", intent="agent observes pest pressure",
                window_days=(0.0, 1.0),
                eligible_tools=[("Mavic3M", "fly_survey"), ("SensorApp", "read_canopy_sensors"), ("Robot0", "inspect_pests")]),
            GateSpec(name="G2_load_pesticide", intent="load pesticide before spray",
                window_days=(0.0, 1.0),
                eligible_tools=[("TractorApp", "load_pesticide"), ("TractorApp", "refill_pesticide_tank")]),
            GateSpec(name="G3_spray", intent="apply pesticide to affected ridges",
                window_days=(0.0, 1.0),
