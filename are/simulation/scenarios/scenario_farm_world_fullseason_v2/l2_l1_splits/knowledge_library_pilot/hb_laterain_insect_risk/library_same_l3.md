# Knowledge Library Pilot: hb_laterain_insect_risk

## Purpose

This library is a structured L2 skill context for `scenario_full_season_hb_laterain_insect_risk`.
...
- source_l2: `scenario_l2_hb_laterain_insect_establishment_planting`
...
### 2. r5_insecticide_36_55

- source_l2: `scenario_l2_hb_laterain_insect_r5_insecticide_36_55`
- farming_group: `management`
- task_type: `insecticide`; crop_stage: `R5`
...
[
  {
    "seq": "ordered",
    "tools": "overview>weather_now>forecast(3d)>advance(3d)>weather_now>forecast(3d)>soil_sensors>canopy_sensors>ridge_state(36-55)>mavic_charge>advance(1h)>mavic_survey(36-55)>robot0_status>robot0_charge>advance(1h)>Robot0.inspect_pests(start=36,end=55)>inventory>tractor_status>TractorApp.load_pesticide(liters=71.4)>TractorApp.spray_pesticide(start=36,end=45,L/ridge=3.5)>TractorApp.spray_pesticide(start=46,end=55,L/ridge=3.5)>ridge_state(36-55)"
  }
]
```
...
- source_l2: `scenario_l2_hb_laterain_insect_harvest_window`
...
[
  {
    "seq": "ordered",
    "tools": "weather_now>forecast(3d)>overview>soil_sensors>advance(40d)>weather_now>forecast(3d)>ridge_state(0-31)"
  },
  {
    "seq": "harvest_loop",
    "ridge_range": "0-31",
  ...
  {
    "seq": "ordered",
    "tools": "dry_grain(target=13)>store_grain>weather_now>forecast(3d)>ridge_state(32-63)"
  },
  {
    "seq": "harvest_loop",
    "ridge_range": "32-63",
