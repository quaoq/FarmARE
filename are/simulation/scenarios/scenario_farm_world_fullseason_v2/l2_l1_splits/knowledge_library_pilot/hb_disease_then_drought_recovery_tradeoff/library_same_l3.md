# Knowledge Library Pilot: hb_disease_then_drought_recovery_tradeoff

## Purpose

This library is a structured L2 skill context for `scenario_full_season_hb_disease_then_drought_recovery_tradeoff`.
...
- source_l2: `scenario_l2_hb_disease_drought_establishment_planting`
...
- source_l2: `scenario_l2_hb_disease_drought_mid_fungicide_20_43`
...
### 3. r5_irrigation_20_43

- source_l2: `scenario_l2_hb_disease_drought_r5_irrigation_20_43`
- farming_group: `management`
...
[
  {
    "seq": "ordered",
    "tools": "overview>weather_now>forecast(3d)>advance(3d)>weather_now>forecast(3d)>soil_sensors>canopy_sensors>ridge_state(20-43)>mavic_charge>advance(1h)>mavic_survey(20-43)>Matrice4T.charge>advance(1h)>Matrice4T.fly_survey(start=20,end=43)>robot0_status>robot0_charge>advance(1h)>robot0_crop_check(start=20,end=43)>inventory>tractor_status>FieldOpsApp.irrigate(start=20,end=43,hours=0.75)>advance(6h)>ridge_state(20-43)"
  }
]
```
...
- source_l2: `scenario_l2_hb_disease_drought_harvest_window`
...
[
  {
    "seq": "ordered",
    "tools": "weather_now>forecast(3d)>overview>soil_sensors>advance(38d)>weather_now>forecast(3d)>ridge_state(0-63)"
  },
  {
    "seq": "harvest_loop",
    "ridge_range": "0-63",
