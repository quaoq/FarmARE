...
class ScenarioL2HBInsectBudgetR5ManualControl(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        if self.detailed_briefing:
            briefing_text = (
                "截至2026-08-03，田块处于R5始粒期。该田此前已经对中期病害区用过杀菌剂，剩余有效成分预算有限。"
                "后期出现虫害线索，且当天土壤偏湿，不适合无差别机械/大面积喷药。"
                "请先确认天气、土壤通行性、全田状态和库存/预算，再用无人机定位异常冠层，并用地面机器人确认虫口、叶片取食损伤和虫害压力。"
                "不要把病害残余或水肥问题误当虫害；若虫害达到处理阈值，只对确认区域做人工背负式点喷，之后复查虫害压力和预算状态。"
            )
        else:
            briefing_text = "R5期虫害阈值窗口且喷药预算有限。请完成观察、定位、地面虫害确认、人工点喷和复查。"
