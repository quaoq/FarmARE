...
class ScenarioL1HBInsectBudgetManualInsecticide(Scenario):
    ...
    def build_events_flow(self) -> None:
        ...
        if self.detailed_briefing:
            briefing_text = (
                "截至2026-08-03，田块处于R5虫害处理前复核状态。"
                "请做最小证据复核：当前天气、土壤偏湿背景、剩余预算、目标区冠层异常和地面虫口/取食损伤。"
                "若虫害阈值仍成立，使用人工背负式点喷完成确认虫害区杀虫；不要用杀菌剂或水肥处理虫害，也不要扩展到健康参照区。"
            )
        else:
            briefing_text = "请复核R5虫害证据和预算，然后对确认区域执行人工背负式点喷杀虫。"
