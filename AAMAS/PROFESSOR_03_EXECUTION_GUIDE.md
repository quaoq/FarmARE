...
The repaired runtime passes 401 regression cases, including distributed,
physics-orchestrator and native action-executor checks. Exact XML hashes and source identity are
in `handover_validation/repair_20260914_regression.json`. Subsequent source
