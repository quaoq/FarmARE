"""Run hb_organic_weed_pressure_allowed_inputs oracle and export daily engine CSVs."""
...
TRACE_APP_NAME = "HbOrganicWeedPressureAllowedInputsDailyTrace"
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=Path,
        default=Path(
            "docs/ai/hb-organic-weed-pressure-allowed-inputs-field-summary.csv"
        ),
    )
    parser.add_argument(
        "--ridge-csv",
        type=Path,
        default=Path(
            "docs/ai/hb-organic-weed-pressure-allowed-inputs-ridge-states.csv"
        ),
    )
    parser.add_argument(
        "--trace-json",
        type=Path,
        default=Path(
            "docs/ai/hb-organic-weed-pressure-allowed-inputs-oracle-trace.json"
        ),
    )
