"""Run hb_highweedseedbank_lowchemical oracle and export daily engine CSVs."""
...
TRACE_APP_NAME = "HbHighweedseedbankLowchemicalDailyTrace"
...
def main() -> int:
    ...
    parser.add_argument(
        "--field-csv",
        type=Path,
        default=Path("docs/ai/hb-highweedseedbank-lowchemical-field-summary.csv"),
    )
    parser.add_argument(
        "--ridge-csv",
        type=Path,
        default=Path("docs/ai/hb-highweedseedbank-lowchemical-ridge-states.csv"),
    )
    parser.add_argument(
        "--trace-json",
        type=Path,
        default=Path("docs/ai/hb-highweedseedbank-lowchemical-oracle-trace.json"),
    )
