"""Run hb_mechanical_weed_control_soil_wetness oracle and export daily engine CSVs."""
...
TRACE_APP_NAME = "HbMechanicalWeedControlSoilWetnessDailyTrace"
...
def main() -> int:
    ...
    parser.add_argument(
        "--field-csv",
        type=Path,
        default=Path("docs/ai/hb-mechanical-weed-control-soil-wetness-field-summary.csv"),
    )
    parser.add_argument(
        "--ridge-csv",
        type=Path,
        default=Path("docs/ai/hb-mechanical-weed-control-soil-wetness-ridge-states.csv"),
    )
    parser.add_argument(
        "--trace-json",
        type=Path,
        default=Path("docs/ai/hb-mechanical-weed-control-soil-wetness-oracle-trace.json"),
    )
